...
class DentistDetails extends Component {
    ...
    render() {
        ...
        const specialist = this.props.location.state.specialist;
        return (
            
            <React.Fragment>
                <Banner pageTitle={`Dr. Nathan Currie - ${specialist}`} />
                        ...
                        <div className="row">
                            <div className="col-md-7 col-lg-8 col-12">
                                <div className="single-dentist-details">
                                    <h2>Dr. Nathan Currie - {specialist} <span>(DMD, MS, DICOI)</span></h2>
